...
public final class Constants {
     ...
     */
    static public final int      MAIN_SERVER_PORT    = 60536;
    
    /**
     * Prefix for multi-cast addresses.
     */
    public static final String   MULTICAST_IP_PREFIX = "225.3.4.5";

    /**
     * Port number for the multi-cast.
     */
    static public final int      MULTICAST_PORT      = 52502;

    /**
     * Port number for the uni-cast.
     */
    static public final int      UNICAST_PORT        = 52505; 
